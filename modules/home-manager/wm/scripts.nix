...
in
{
  monitorToggleScript = pkgs.writeShellScriptBin "toggleMonitor.sh" ''
    #!/usr/bin/env bash
  ...
  animationsToggleScript = pkgs.writeShellScriptBin "animationsToggle.sh" ''
    #!/usr/bin/env bash
  ...
  decorationsToggleScript = pkgs.writeShellScriptBin "decorationsToggle.sh" ''
    #!/usr/bin/env sh
  ...
  gapsToggleScript = pkgs.writeShellScriptBin "gapsToggle.sh" ''
    #!/usr/bin/env bash
  ...
  forceKillScript = pkgs.writeShellScriptBin "forceKill.sh" ''
    #!/usr/bin/env bash
